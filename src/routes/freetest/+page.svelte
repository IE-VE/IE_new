...
<svelte:head>
	<title>Free IELTS Speaking Test with AI Feedback | InsideIELTS.com</title>
	<meta
		name="description"
		content="Practice IELTS Speaking with instant AI feedback. Get your band score, detailed analysis, and personalised tips to improve. No registration needed. Try free now!"
	/>
</svelte:head>
...
>
	<div class="absolute inset-0 bg-gradient-to-tr from-teal-200/20 to-transparent" />
			...
			<div class="w-full md:w-2/5">
				<div class="relative mx-auto max-w-sm">
					...
					<Card class="relative shadow-lg">
						...
						<Button href="/record" onclick={handleStartTest} color="primary">Start Free Test</Button
						>
					</Card>
				</div>
			</div>
...
<section class="relative py-16">
	...
	<div class="relative container mx-auto px-6">
		<div class="mb-12 text-center">
			...
			<div class="mx-auto mt-4 h-1 w-24 rounded-full bg-teal-500/40" />
			...
			{#each valueProps as prop}
				<Card>
					<div class="flex flex-col items-center">
						...
						<div class="mx-auto mb-4 h-1 w-12 rounded-full bg-teal-500/40" />
...
<section id="how-it-works" class="section-divider relative overflow-hidden py-16">
	...
	/>
	<div class="absolute inset-0 bg-[url('/grid.svg')] opacity-5 mix-blend-soft-light" />
